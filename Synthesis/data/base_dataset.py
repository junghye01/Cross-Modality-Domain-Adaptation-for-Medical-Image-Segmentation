...
def get_transform(opt, params=None, grayscale=False, method=Image.BICUBIC, convert=True,to_tensor=True,is_mask=False):
    transform_list = []
    ...
    if convert and not is_mask:
        ...
        transform_list.append(transforms.Lambda(lambda img: torch.from_numpy(np.array(img, np.int64, copy=False))))
